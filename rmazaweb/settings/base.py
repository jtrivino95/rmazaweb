...
WSGI_APPLICATION = 'rmazaweb.wsgi.application'
...
WAGTAIL_SITE_NAME = 'Reparaciones Maza S.L.'
...
WAGTAILADMIN_NOTIFICATION_FROM_EMAIL = 'contacto@reparacionesmaza.com'
